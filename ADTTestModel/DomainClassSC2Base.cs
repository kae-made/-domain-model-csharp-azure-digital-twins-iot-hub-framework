...
{
    public partial class DomainClassSC2Base : DomainClassSC2
    {
        protected static readonly string className = "SC2";
        ...
        public static DomainClassSC2Base CreateInstance(InstanceRepository instanceRepository, Logger logger=null, IList<ChangedState> changedStates=null, bool synchronousMode = false)
        {
            var newInstance = new DomainClassSC2Base(instanceRepository, logger, synchronousMode);
            if (logger != null) logger.LogInfo($"@{DateTime.Now.ToString("yyyyMMddHHmmss.fff")}:SC2(TSId={newInstance.Attr_TSId}):create");
        ...
        public DomainClassSC2Base(InstanceRepository instanceRepository, Logger logger, bool synchronousMode)
        {
        ...
        public static bool Compare(DomainClassSC2 instance, IDictionary<string, object> conditionPropertyValues)
        {
            bool result = true;
        ...
        public DomainClassTS GetSuperClassR4()
        {
            if (relR4TS == null)
            {
                ...
                {
                   if (instanceRepository.ExternalStorageAdaptor != null) candidates = instanceRepository.ExternalStorageAdaptor.CheckTraverseStatus(DomainName, this, "TS", "R4_SC2", candidates, () => { return DomainClassTSBase.CreateInstance(instanceRepository, logger); }, "any").Result;
                }
        ...
        public bool LinkR4(DomainClassTS instance, IList<ChangedState> changedStates=null)
        {
            ...
            if (relR4TS == null)
            {
                ...
                if (logger != null) logger.LogInfo($"@{DateTime.Now.ToString("yyyyMMddHHmmss.fff")}:SC2(TSId={this.Attr_TSId}):link[TS(TSId={instance.Attr_TSId})]");
        ...
        public bool UnlinkR4(DomainClassTS instance, IList<ChangedState> changedStates=null)
        {
            ...
            if (relR4TS != null && ( this.Attr_TSId==instance.Attr_TSId ))
            {
                ...
                if (logger != null) logger.LogInfo($"@{DateTime.Now.ToString("yyyyMMddHHmmss.fff")}:SC2(TSId={this.Attr_TSId}):unlink[TS(TSId={instance.Attr_TSId})]");
        ...
        {
            if (logger != null) logger.LogInfo($"@{DateTime.Now.ToString("yyyyMMddHHmmss.fff")}:SC2(TSId={this.Attr_TSId}):delete");

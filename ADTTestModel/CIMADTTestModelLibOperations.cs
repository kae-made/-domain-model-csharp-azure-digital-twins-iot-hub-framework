...
namespace ADTTestModel
{
    public partial class CIMADTTestModelLib
    {
        ...
        public void TestExternalEntity()
        {
            ...
            var _eeSTRRef_ = (Kae.DomainModel.Csharp.Framework.ExternalEntities.STR.STRWrapper)instanceRepository.GetExternalEntity("STR");
        ...
        public IList<string> CreateExternalEntities()
        {
            ...
            instanceRepository.Add(new Kae.DomainModel.Csharp.Framework.ExternalEntities.STR.STRImpl());
